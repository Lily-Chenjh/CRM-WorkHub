...
<body background="images/background_2.png">
    ...
    <!-- container with all login data -->
    <div class="container">
        <div class="row justify-content-center" style="text-align:center;"><h6 style="color:white; font-size:28px; padding-left:50px;">Admin</h6><h5 style="color:#00bcd4; font-size:28px; "> Log In</h5>
        </div>
                ...
                <div class="card-body_admin">
                    ...
                    <form method="POST" action="{{ url('admin')}}">{{ csrf_field() }}
                        ...
                        <div class="form-group2">
                            <label for="email" class="col-sm-6 col-form-label text-md-center" style="color:#cccccc;margin-top: 70px;">{{ __('Email') }}
                            </label>
                        ...
                        <!-- password input -->
                        <div class="form-group2">
                            <label for="password" class="col-md-6 col-form-label text-md-center" style="color:#cccccc;">{{ __('Password') }}
                            </label>
                            <div class="col-md-6">
